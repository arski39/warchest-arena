...
ARENA_PUBLIC_RPC_URL=$ARENA_PUBLIC_RPC_URL
ARENA_PROGRAM_ID=$ARENA_PROGRAM_ID
ARENA_STAKE_MINT=$ARENA_STAKE_MINT
ARENA_STAKE_SYMBOL=$ARENA_STAKE_SYMBOL
ARENA_RAKE_BPS=$ARENA_RAKE_BPS
ARENA_MAX_ENTRY_FEE=$ARENA_MAX_ENTRY_FEE
ARENA_PUBLIC_WAGER_LOBBIES=$ARENA_PUBLIC_WAGER_LOBBIES
TREASURY_TOKEN_ACCOUNT=$TREASURY_TOKEN_ACCOUNT
ARENA_DEV_BYPASS=$ARENA_DEV_BYPASS
ARENA_AUTHORITY_KEYPAIR=$ARENA_AUTHORITY_KEYPAIR
SITE_NAME=$SITE_NAME
...
AUTH_ALLOW_PUBLIC_LOBBIES=$AUTH_ALLOW_PUBLIC_LOBBIES
