    ...
    return html`
      ...
      >
        ...
        >
          ...
          >
            <!-- [ARENA] Reddit and Discord stay. docs/branding.md lists them as
               upstream attribution preserved under AGPL §7, which asks that
               notices be kept rather than scrubbed; §7 forbids presenting this
               as official OpenFront, which is handled by the name, logo and
               title, not by deleting links.

               The openfront.wiki link IS removed: it is documentation for
               upstream's game, not an author attribution, and it documents
               rules this fork has changed. The GitHub link above is the AGPL
               §13 source offer and is not optional. -->
            <a
